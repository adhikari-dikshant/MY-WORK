...
public class Calender{
    public static void main(String[] args) {
        ...
        System.out.print("ENTER THE YEAR: ");           // display mssg only
        int yy = sc.nextInt();                         //  reading integer input value
        System.out.print("ENTER THE MONTH: ");        // display mssg only
        ...
        String[] day = {"SUN", "MON", "TEUS", "WED", "THURS", "FRI", "SAT", "SUN"};
