...
function Map() {
    ...
    this.get_coords = function(a) {
        return {
            x: this.tile_size * a[1] + this.tile_size / 2,
...
function Minimap(map, colors) {
    ...
    var mx = window.innerWidth - 228 + "px",
        my = "40px",
        x = "calc(100vw - 72px)",
        y = "40px";
    ...
    var move = function(e) {
        ...
        if (drag && e.target === mini) {
            var tx = x - 16,
                ty = y - 16;
            mini.style.left = tx + "px";
            mini.style.top = ty + "px";
            canvas.style.left = tx - width + 32 + "px";
